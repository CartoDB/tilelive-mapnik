...
const createMetatileCache = require('./metatile');
...
MapnikSource.prototype._open = function (callback) {
    ...
    this._loadXML((err, xml) => {
        ...
        this._tileCache = createMetatileCache(this, this._uri.query.metatileCache);
        this._pool = createMapPool(this._uri, xml);
