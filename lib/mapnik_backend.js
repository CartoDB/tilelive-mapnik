...
MapnikSource.prototype._sliceMetatile = function (image, options, metatile, stats, callback) {
    ...
    Promise.all(metatile.tiles.map((coords) => {
        return new Promise((resolve, reject) => {
            ...
            this._encodeImage(image, options, x, y, (err, encodedImage) => {
                if (err) {
                    return reject(err);
                }
...
MapnikSource.prototype._encodeImage = function (image, options, x, y, callback) {
